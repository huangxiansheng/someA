package com.hs.aliyuncs.alidns;
...
public class DomainRecord {
	...
	static {
		...
		String accessKeyId = "LTAIMIOurpwKc06Z"; // your accessKey
		String accessKeySecret = "9AQJGKKG7QNSTnGYRfewrWIMclPYn6";// your accessSecret
	...
	public static void main(String[] args) {
		...
		request.setDomainName("huangs.win");
